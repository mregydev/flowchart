<template>
    <div class="edit-container">
        ...
        <VForm class="edit-node-form" v-model="isValid" fast-fail @submit.prevent="editButtonClicked">
            <VTextField variant="solo" v-model="label" :rules="rules" label="Title"></VTextField>
            <VTextarea variant="solo" v-model="description" :rules="rules" label="Description"></VTextarea>
            <AttachmentsEditor :image-urls="selectedNode?.data.imagesUrls" @imagesChange="imagesChanged"
                v-if="selectedNode?.type === 'sendMessage'"></AttachmentsEditor>
